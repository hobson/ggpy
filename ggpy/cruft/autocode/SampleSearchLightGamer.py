#!/usr/bin/env python
""" generated source for module SampleSearchLightGamer """
...
class SampleSearchLightGamer(StateMachineGamer):
    """ generated source for class SampleSearchLightGamer """
    # 
    # 	 * Does nothing
    # 	 
    ...
    def stateMachineSelectMove(self, timeout):
        ...
        #  immediately take it.
        reasonableMoveFound = False
        maxGoal = 0
        for moveUnderConsideration in movesInRandomOrder:
            ...
            if System.currentTimeMillis() > start + 2000 and reasonableMoveFound:
                break
            ...
            #  they will take it.
            for jointMove in theMachine.getLegalJointMoves(nextState):
