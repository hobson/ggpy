#!/usr/bin/env python
""" generated source for module SentenceFormModel """
...
#  
class SentenceFormModel(object):
    """ generated source for interface SentenceFormModel """
    ...
    # 	 
    @abstractmethod
    def getSentenceForm(self, transformed):
