...
class LeaderboardPanel(JPanel implements Observer):
{
    leaderTable = JTable()
    ...
    def LeaderboardPanel()
	{
        ...
        sorter.setComparator(1, new Comparator<Integer>():
        		    def int compare(Integer a, Integer b):
                return a-b;
		});
    ...
    def static List<Integer> getErrorCounts(List<List<String>> errorHistory):
