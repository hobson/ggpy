...
class FunctionInfoImpl implements FunctionInfo {
    ...
    def FunctionInfoImpl(form=SentenceForm(), Set<GdlSentence> trueSentences) throws InterruptedException {
        this.form = form;
    ...
    def Map<ImmutableList<GdlConstant>, GdlConstant> getValueMap(int index):
    ...
    def static FunctionInfo create(SentenceForm form,
