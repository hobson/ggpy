...
class CommonTransforms(object):
    ...
    def Gdl replaceVariableInternal(Gdl gdl, GdlVariable toSubstitute, GdlTerm theReplacement):
        ...
        elif(gdl instanceof GdlProposition):
            return gdl
        ...
        elif(gdl instanceof GdlConstant):
            return gdl
        ...
        elif(gdl instanceof GdlVariable):
            if(gdl == toSubstitute):
    ...
    def Gdl replaceVariablesInternal(Gdl gdl,
		...
		elif (gdl instanceof GdlDistinct):
