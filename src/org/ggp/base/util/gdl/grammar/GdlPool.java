...
class GdlPool
    ...
    def static Gdl immerse(Gdl foreignGdl):
        ...
        elif(foreignGdl instanceof GdlRule):
        ...
        elif(foreignGdl instanceof GdlConstant):
            return GdlPool.getConstant(((GdlConstant) foreignGdl).getValue())
        elif(foreignGdl instanceof GdlFunction):
        ...
        elif(foreignGdl instanceof GdlVariable):
