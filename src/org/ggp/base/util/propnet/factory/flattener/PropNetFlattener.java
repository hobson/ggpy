...
class PropNetFlattener(object):
    ...
    private class RuleReference 
        ...
        def RuleReference(GdlRule originalRule)
            ...
            return rhs.productionTemplate==self.productionTemplate && rhs.conditions.equals(self.conditions)
    ...
    private class Domain 
        def Domain(GdlTerm name, GdlTerm name2) self.name = name; self.name2 = name2
