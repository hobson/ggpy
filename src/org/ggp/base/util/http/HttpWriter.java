...
class HttpWriter
{
    ...
    def static void writeAsClient(Socket socket, String hostField, String data, String playerName) throws IOException
	{
        PrintWriter pw = new PrintWriter(socket.getOutputStream());
    ...
    def static void writeAsServer(Socket socket, String data) throws IOException
	{
        PrintWriter pw = new PrintWriter(socket.getOutputStream());
