...
class JZebraTable(javax.swing.JTable):
{
    ...
    def JZebraTable(numRows=int(), int numColumns)
	{
        super(numRows, numColumns);

    def JZebraTable(java.util.Vector<?> rowData, java.util.Vector<?> columnNames)
	{
        super(rowData, columnNames);

    def JZebraTable(javax.swing.table.TableModel dataModel)
	{
        super(dataModel);

    def JZebraTable(javax.swing.table.TableModel dataModel, javax.swing.table.TableColumnModel columnModel)
	{
        super(dataModel, columnModel);

    def JZebraTable(javax.swing.table.TableModel dataModel, javax.swing.table.TableColumnModel columnModel, javax.swing.ListSelectionModel selectionModel)
	{
        super(dataModel, columnModel, selectionModel);

    def JZebraTable(Object[][] rowData, Object[] columnNames)
	{
        super(rowData, columnNames);
    ...
    def java.awt.Component prepareEditor(javax.swing.table.TableCellEditor editor, int row, int col)
	{
    ...
    def java.awt.Component prepareRenderer(javax.swing.table.TableCellRenderer renderer, int row, int col)
	{
