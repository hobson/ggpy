...
class ProjectSearcher(object):
    ...
    def class LoadedClasses<T> 
        ...
        private LoadedClasses(Class<T> interfaceClass):
            ...
            self.allClasses = ImmutableSet.copyOf(REFLECTIONS.getSubTypesOf(interfaceClass))
            self.concreteClasses = ImmutableSet.copyOf(Sets.filter(allClasses, IS_CONCRETE_CLASS))
