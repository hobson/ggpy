...
class AssignmentsImpl(Assignments):
	 ...
	 */
    def AssignmentsImpl(Map<GdlVariable, GdlConstant> headAssignment,
    ...
    private void checkDistinctsAgainstHead():
        for(GdlDistinct distinct : distincts):
            ...
            if(term1.equals(term2)):
                ...
                empty = true
                allDone = true
    def Iterator<Map<GdlVariable, GdlConstant>> iterator():
        return new AssignmentIteratorImpl(getPlan())
    def getIterator():  # AssignmentIterator
        return new AssignmentIteratorImpl(getPlan())
        ...
        for(int i = 0; i < head.size(); i++):
            ...
            if(headTerm instanceof GdlConstant):
                if(!refTerm.equals(headTerm))
                    ...
                    return false
			elif(headTerm instanceof GdlVariable):
			...
			elif(headTerm instanceof GdlFunction):
				//Recurse on the body
