...
class Validator(JPanel implements ActionListener):
    ...
    millisToSimulateField = JTextField()
    simulationsTabbedPane = JTabbedPane()
    ...
    def Validator()
        ...
        self.add(sourcePanel, new GridBagConstraints(0, 0, 1, 1, 0.0, 1.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(5, 5, 5, 5), 5, 5))
        self.add(simulationsPanel, new GridBagConstraints(1, 0, 1, 1, 1.0, 1.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(5, 5, 5, 5), 5, 5))
